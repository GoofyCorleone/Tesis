    ...
    \section{Fundamentos de la TFFr integral}
       ...
       \subsection{Orden complejo}
            ...
            \begin{definition}
                ...
                \begin{equation*}
                    ||f||_{\alpha,\beta} := \left|\left| e^{x^\alpha} D^\beta f \right|\right|_{L^\infty\left(\mathbb{R}^n\right)} = \sup_{x\in\mathbb{R}}\left|\frac{\partial^{|\beta|}f}{\partial x_{j_1}^{\beta_1}...x_{j_k}^{\beta_k}}  e^{x_{i_1}^{\alpha_1}...x_{i_m}^{\alpha_m} } \right|
                \end{equation*},
