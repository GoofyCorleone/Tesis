...
\fancyhead[L]{\leftmark}
    ...
    \section{Fundamentos de la TFFr integral}
       ...
       \subsection{Orden real}
            ...
            \begin{proof}
                ...
                \begin{equation*}
                    \left| \left(\mathcal{F}_\alpha f \right)(x) \right| \leq \int_{\mathbb{R}^n}\left|K_\alpha \left( \mathbf{x},\mathbf{x}' \right)\right| \left|f(\mathbf{x}')\right|d\mathbf{x}' = \left|A_\alpha\left(\mathbf{x},\mathbf{x}' \right)\right| \int_{\mathbb{R}^n}\left|f\left(\mathbf{x}'\right)\right|d\mathbf{x}',
                \end{equation*}
                \begin{equation}
                    \left| \left(\mathcal{F}_\alpha f \right)(x) \right| \leq \left| A_\alpha \left(\mathbf{x}\right)\right|\; ||f||_{L^1\left(\mathbb{R^n}\right)},
                \end{equation}
	...
	\begin{proof}
		...
		\begin{equation*}
			\mathcal{F}_\alpha\left\{ f \right\} = \sum_{n=0}^{\infty}a_n \mathcal{F}_\alpha\left\{ \varphi_n \right\} = \sum_{n=0}^{\infty}a_ne^{-in\alpha\pi /2}\varphi_n,
		\end{equation*}
		...
		La norma de $\mathcal{F}_\alpha\left\{f\right\}$ es
		\begin{equation*}
			\left|\left|  \mathcal{F}_\alpha\left\{f\right\}  \right|\right|^2_{L^2\left(\mathbb{R}^n\right)} = \left\langle \sum_{n=0}^{\infty} a_n e^{-in\alpha\pi/2}\varphi_n, \sum_{n'=0}^{\infty} a_{n'}e^{-in'a\pi/2}\varphi_{n'} \right\rangle,
		\end{equation*}
		\begin{equation*}
			\left|\left|  \mathcal{F}_\alpha\left\{f\right\}  \right|\right|^2_{L^2\left(\mathbb{R}^n\right)} = \sum_{n=0}^{\infty} |a_n|^2,
		\end{equation*}
