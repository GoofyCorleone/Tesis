...
\fancyhead[L]{\leftmark}
    ...
    \section{Nociones básicas}
        ...
        \begin{align}
            & \left( \mathcal{F}_\alpha f \right)(x) = \frac{e^{i\left(\frac{1}{4}\pi \tilde{\alpha} - \frac{1}{2}\alpha \right)} }{\sqrt{ 2\pi \left|\sen\alpha \right| }^{1/2}}e^{-\frac{i}{2}x^2\cot\alpha}\int_{\mathbb{R}}\exp\left(\frac{ixx'}{\sen\alpha} - \frac{1}{2}ix'^2\cot\alpha\right)f(x')dx', \quad 0 < |\alpha| < \pi,\label{eq:Cap2FourierInt1DMejor}\\
        ...
        Con esto en mente, A. McBride y F. Kerr demostraron los siguientes teoremas.
