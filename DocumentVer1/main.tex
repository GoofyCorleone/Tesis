...
\newenvironment{Proof}[1][\proofname]{%
  ...
  \trivlist
  \item[\hskip\labelsep\bfseries\textbf{#1.}]\ignorespaces%
}{%
...
% Numeración de ecuaciones por sección: (capítulo.sección.número), e.g. (2.1.3)
...
% Reiniciar el contador de ecuaciones al inicio de cada sección
\makeatletter
